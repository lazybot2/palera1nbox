...
sudo apt-get install -y i2c-tools git wget vim armbian-config python3-dev python3-pil python3-smbus python3-pip python3-serial
...
case $nanopi in
    ...
    wget -O palera1n https://github.com/palera1n/palera1n/releases/download/v2.0.1/palera1n-linux-armel
    ;;
    1)
    ...
    wget -O palera1n https://github.com/palera1n/palera1n/releases/download/v2.0.1/palera1n-linux-arm64
    ;;
esac
